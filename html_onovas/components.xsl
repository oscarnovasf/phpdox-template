<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- CABECERA DE LA WEB 2 -->
  <xsl:template name="head-info">
    <div id="index">
      <div id="projectinfo">
      ...
      <div id="buildinfo">
        ...
        <p>
          ...
          rama: <xsl:value-of select="$current/@branch" />
        </p>
        <h3>Incluye</h3>
        <p>
  ...
  <xsl:template name="nav">
    <nav class="topnav">
      <div class="container">
        <ul>
          <li>
            <div class="logo"><span>/**</span>documentación técnica</div>
          </li>
          <li class="separator"><a href="{$base}index.{$extension}">Información</a></li>
          ...
          <xsl:if test="$hasClasses = 'Y'">
            <li><a href="{$base}classes.{$extension}">Clases</a></li>
          </xsl:if>
          <xsl:if test="$hasTraits = 'Y'">
            <li><a href="{$base}traits.{$extension}">Traits</a></li>
          </xsl:if>
          <li class="separator"><a href="{$base}source/index.{$extension}">Código Fuente</a></li>
        </ul>
      </div>
    </nav>
  </xsl:template>
  ...
  <xsl:template name="footer">
    <footer>
      <div class="container">
        <span><xsl:value-of select="$project" /> - Documentación Técnica</span>
      </div>
    </footer>
  </xsl:template>
